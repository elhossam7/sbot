...
export async function executeSellOrder(connection, tokenMint, amount, minPrice) {
    try {
...
export async function getUserBalance(connection, userId) {
    try {
...
export async function getUserTokenBalance(connection, userId, token) {
    try {
...
export async function getTokenPrice(connection, token) {
    try {
...
export async function executeBuyOrder({ connection, userId, token, amount, price }) {
    try {
        ...
        const tradeResult = await connection.sendTransaction(new Transaction().add( /* buy instruction */), []);
...
export async function updateUserPortfolio(userId, params) {
    try {
